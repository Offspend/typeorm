    ...
    it("all types should work correctly - persist and hydrate", () =>
        Promise.all(
            connections.map(async (connection) => {
                ...
                loadedPost.characterVarying.should.be.equal(
                    post.characterVarying,
                )
                loadedPost.text.should.be.equal(post.text)
                loadedPost.citext.should.be.equal("This is text")
                loadedPost.hstore.should.be.equal(
                    `"age"=>"30", "name"=>"Alice", "surname"=>"A"`,
                )
                loadedPost.bytea
                    .toString()
                ...
                loadedPost.tsrange.should.be.eql(
                    `["2010-01-01 14:30:00","2010-01-01 15:30:00")`,
                )
                loadedPost.tstzrange.should.be.eql(
                    `["2010-01-01 14:30:00+00","2010-01-01 15:30:00+00")`,
                )
                ...
                table!
                    ...
                    .type.should.be.equal("character varying")
                table!
                ...
                table!
                    ...
                    .type.should.be.equal("numeric")
                table!
                    .findColumnByName("doublePrecision")!
                    .type.should.be.equal("double precision")
                table!
                    .findColumnByName("float8")!
                    .type.should.be.equal("double precision")
                ...
                table!
                    .findColumnByName("character")!
                    .type.should.be.equal("character")
                table!
                    .findColumnByName("varchar")!
                    .type.should.be.equal("character varying")
                table!
                    .findColumnByName("characterVarying")!
                    .type.should.be.equal("character varying")
                table!.findColumnByName("text")!.type.should.be.equal("text")
                table!
                    .findColumnByName("citext")!
                    .type.should.be.equal("citext")
                table!
                    .findColumnByName("hstore")!
                ...
                table!
                    .findColumnByName("interval")!
                    .type.should.be.equal("interval")
                table!
                    .findColumnByName("time")!
                    .type.should.be.equal("time without time zone")
                table!
                    .findColumnByName("timeWithTimeZone")!
                    .type.should.be.equal("time with time zone")
                table!
                    .findColumnByName("timetz")!
                    .type.should.be.equal("time with time zone")
                table!
                ...
                table!
                    ...
                    .type.should.be.equal("polygon")
                table!
                    .findColumnByName("circle")!
                    .type.should.be.equal("circle")
                ...
                table!
                    ...
                    .type.should.be.equal("bit varying")
                table!
                    .findColumnByName("bitVarying")!
                    .type.should.be.equal("bit varying")
                ...
                table!
                    .findColumnByName("int8range")!
                    .type.should.be.equal("int8range")
                table!
                    .findColumnByName("numrange")!
                    .type.should.be.equal("numrange")
                table!
                    .findColumnByName("tsrange")!
                    .type.should.be.equal("tsrange")
                table!
                    .findColumnByName("tstzrange")!
                    .type.should.be.equal("tstzrange")
                table!
        ...
        Promise.all(
            connections.map(async (connection) => {
                ...
                loadedPost.timeWithTimeZone
                    .valueOf()
                    .should.be.equal(post.timeWithTimeZone.valueOf())
                loadedPost.int4range
                    .valueOf()
                    .should.be.equal(post.int4range.valueOf())
                ...
                table!
                    .findColumnByName("int4range")!
                    .isNullable!.should.be.equal(true)
            }),
        ))
